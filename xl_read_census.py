...
wb = openpyxl.load_workbook('xl_censuspopdata.xlsx')
...
with open('xl_census2010.py', 'w') as result_file:                            # 'w' is for writing. Can also use 'a+' for appending and writing
    result_file.write('all_data = ' + pprint.pformat(county_data))
print('Done.\n')

# An example of how to access the data easily from xl_census2010.py
import xl_census2010
print('The population of Anchorage, AK was:', xl_census2010.all_data['AK']['Anchorage']['pop'])
print('The population of Sweetwater, WY was:', xl_census2010.all_data['WY']['Sweetwater']['pop'])
